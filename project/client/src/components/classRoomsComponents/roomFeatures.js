...
const roomFeatures = (props) => {
    ...
    const onRoomFeatureChange =  (e) => {
        props.roomFeatureChange(e.target.value);
    }
    ...
    return (
        <div className="card">
                    ...
                    <div className="col-6">
                        <div className="input-group mt-3 mb-3">
                            ...
                            <input
                                ...
                                placeholder="מאפיין..."
                                value={props.roomFeature}
                                aria-label="Username"
                                aria-describedby="basic-addon1"
                                onChange={(e) => (onRoomFeatureChange(e))}>
                            </input>
                        </div>
                        <button type="button" className="btn btn-secondary" onClick={() => props.addRoomFeature()}>הוסף מאפיין</button>
                    </div>
                    <div className="col-6">
                        <DataTable
                            table="roomFeatures"
            ...
            <AlertMessage
                ...
                messageStatus={props.alertMessageForFeaturesStatus}>
            </AlertMessage>
        </div>
    )
};
