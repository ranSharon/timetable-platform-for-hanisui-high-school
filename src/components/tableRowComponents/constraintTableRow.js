      ...
      return (
        <td className="border-top border-dark text-left">
          <button
            ...
            onClick={() => props.onEdit(props.constraint._id)}
          >
            ערוך
          </button>
          ...
          <button
            type="button"
            className="btn btn-secondary btn-sm mb-1"
            onClick={() => props.onDelete(props.constraint._id)}
          >
            מחק
          </button>
        </td>
    ...
    return (
      <tr className="text-center">
        ...
        <td className="border-top border-dark">
          {yesOrNo(props.constraint.lessonSplit)}
        </td>
        <td className="border-top border-dark">
          {yesOrNo(props.constraint.subjectGrouping)}
        </td>
        {actionButtons()}
      </tr>
    );
